...
var _PrepareBillListSearchForm = __webpack_require__(1366);

var _PrepareBillListSearchForm2 = _interopRequireDefault(_PrepareBillListSearchForm);
...
var ProductComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function ProductComponent(props) {
        ...
        props.store.searchPrepareList({ condition: condition, current: current, pageSize: pageSize });
        props.store.billTotalCount({ condition: condition });
        return _this;
    }
    ...
    _createClass(ProductComponent, [{
        ...
        value: function handleOnChange(event) {
            ...
            if (event.target.checked) {
                ...
                this.idList.map(function (item, index) {
                    if (item.id == event.target.value) {
                        _this2.idList.splice(index, 1);
                    }
                });
            }
        }
        ...
        value: function handleSubmit() {
            ...
            this.searchForm.validateFields(function (err, data) {
                if (err) {
                    ...
                    var condition = data;
                    var _props$store2 = _this3.props.store,
                        current = _props$store2.current,
                        pageSize = _props$store2.pageSize;

                    _this3.props.store.searchPrepareList({ condition: condition, current: current, pageSize: pageSize });
                    _this3.props.store.billTotalCount({ condition: condition });
                }
            });
        }
    }, {
        ...
        value: function changePage(page) {
            ...
            this.props.store.searchPrepareList({ condition: condition, current: current, pageSize: pageSize });
        }
    }, {
        key: 'getForm',
        ...
        value: function render() {
            ...
            var _props$store4 = this.props.store,
                ...
                tatalCount = _props$store4.tatalCount,
                accountObjList = _props$store4.accountObjList,
                PrepareList = _props$store4.PrepareList,
            ...
            var columns = [{
                ...
                render: function render(text, record) {
                    return _react2.default.createElement(
                        'a',
                        { onClick: _this4.goTo.bind(_this4, "/Frame/PrepareBillDetail", '' + record.id) },
                        record.billNo
                    );
                }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_PrepareBillListSearchForm2.default, {
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_table2.default, { rowKey: function rowKey(record) {
                                    return record.id;
                                }, columns: columns, dataSource: [].concat(_toConsumableArray(PrepareList)), pagination: this.state.pagination, size: 'middle' })
                        )
                    )
                ),
                _react2.default.createElement(_pagination2.default, { style: style.Pagination, current: current, pageSize: pageSize, total: tatalCount, onChange: this.changePage.bind(this) })
            );
        }
    }]);
...
var PaymentBillListContainer = _form2.default.create()(ProductComponent);

exports.default = PaymentBillListContainer;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: '\u6536/\u652F' }),
...
var PrepareBillListSearchForm = _form2.default.create()(ProductComponent);

exports.default = PrepareBillListSearchForm;
