...
var ProductComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    _createClass(ProductComponent, [{
        ...
        key: 'handleChecknote',
        value: function handleChecknote(rule, value, callback) {
            if (value.length > 50) {
                callback("备注不能大于50字");
            } else {
                callback();
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            getFieldDecorator("note", {
                                rules: [{ validator: this.handleChecknote.bind(this) }],
...
var _NoteModalForm = __webpack_require__(1367);
...
var ProductComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function ProductComponent(props) {
        ...
        _this.componentWillReceiveProps = function (nextprops) {
            nextprops.store.searchReceiptByKey({ billNo: nextprops.match.params.id });
        ...
        props.store.searchReceiptByKey({ billNo: _this.id });
        //查询单条账单信息
    ...
    _createClass(ProductComponent, [{
        ...
        value: function handleNoteOk() {
            ...
            this.noteForm.validateFields(function (err, data) {
                if (err) {
                    ...
                    _this2.props.store.modifyBillByKey(data, { id: _this2.id });
                    _this2.setState({
                        noteVisible: false
                    });
                }
        ...
        value: function render() {
            ...
            var store = this.props.store;
            var ReceiptDetailTable = store.ReceiptDetailTable;
            var settlementType = { "0": "现结", "1": "月结" };
            var status = { "1": "新增", "2": "已确认", "3": "已开票", "4": "已结款" };
            var BillDataRow = store.BillDataRow;
            var total = store.money.revenueAll - store.money.disbursementAll;
            ...
            return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_table2.default, { columns: columns, rowKey: function rowKey(record) {
                                    return record.id;
                                }, dataSource: [].concat(_toConsumableArray(store.ReceiptDetailTable)), pagination: this.state.pagination, size: 'middle' })
                        )
                    )
                ),
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_col2.default, { span: 9 }),
                    _react2.default.createElement(
                        _col2.default,
                        { span: 15 },
                        _react2.default.createElement(
                            ...
                            { type: 'default', onClick: function onClick() {
                                    window.location.hash = "/Frame/ReceiptList";
...
var ReceiptDetailContainer = _form2.default.create()(ProductComponent);

exports.default = ReceiptDetailContainer;
