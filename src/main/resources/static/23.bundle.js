...
var _SettlementEditInfoForm = __webpack_require__(1376);

var _SettlementEditInfoForm2 = _interopRequireDefault(_SettlementEditInfoForm);
...
var SettlementEditContainer = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(SettlementEditContainer, _Component);

    function SettlementEditContainer(props) {
        _classCallCheck(this, SettlementEditContainer);

        var _this = _possibleConstructorReturn(this, (SettlementEditContainer.__proto__ || Object.getPrototypeOf(SettlementEditContainer)).call(this, props));
    ...
    _createClass(SettlementEditContainer, [{
        key: 'getInfoForm',
        ...
        value: function handleSubmit() {
            ...
            this.InfoForm.validateFields(function (err, data) {
                if (!err) {
                    ...
                    _this2.props.store.SettlementEdit(_this2.InfoFormDataRow, _this2.id);
                }
            });
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_SettlementEditInfoForm2.default, {
    ...
    return SettlementEditContainer;
}(_react.Component)) || _class;

exports.default = SettlementEditContainer;
...
var SettlementComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function SettlementComponent(props) {
        ...
        _this.handleSettlementOnlyOneName = function (rule, value, callback) {
            var common = _this.props.store.orgShortname;
    ...
    /*handleSettlementOnlyOne = (rule,value,callback) =>{
        let common = this.props.store.settlementObjectId;
        if(!value || value==common){
            callback()
        }else{
...
var SettlementEditInfoForm = _form2.default.create()(SettlementComponent);

exports.default = SettlementEditInfoForm;
