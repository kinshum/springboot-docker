...
var BusinessTypeComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(BusinessTypeComponent, _Component);

    function BusinessTypeComponent(props) {
        _classCallCheck(this, BusinessTypeComponent);

        var _this = _possibleConstructorReturn(this, (BusinessTypeComponent.__proto__ || Object.getPrototypeOf(BusinessTypeComponent)).call(this, props));

        _this.handleBusinessOnlyOne = function (rule, value, callback) {
            if (!value) {
                callback();
            } else {
                _this.props.BusinessOnlyOne(value, callback);
            }
        };

        props.businessAddInfoForm(props.form);
        return _this;
    }

    _createClass(BusinessTypeComponent, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            FormItem,
                            _extends({}, formItemLayout, { label: '\u4E1A\u52A1\u7C7B\u578B\u540D\u79F0\uFF1A' }),
                            getFieldDecorator('businessTypeName', {
                                rules: [{ required: true, message: '请填写业务类型名称！', whitespace: true }, { max: 20, message: '业务类型名称过长！' }, { validator: this.handleBusinessOnlyOne.bind(this) }]
...
var BusinessTypeAddInfoForm = _form2.default.create()(BusinessTypeComponent);

exports.default = BusinessTypeAddInfoForm;
...
var BusinessTypeComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function BusinessTypeComponent(props) {
        ...
        _this.handleBusinessOnlyOne = function (rule, value, callback) {
            var common = _this.props.store.businessTypeName;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            FormItem,
                            _extends({}, formItemLayout, { label: '\u4E1A\u52A1\u7C7B\u578B\uFF1A' }),
                            getFieldDecorator('businessTypeName', {
...
var BusinessTypeEditInfoForm = _form2.default.create()(BusinessTypeComponent);

exports.default = BusinessTypeEditInfoForm;
...
var _BusinessTypeStyle = __webpack_require__(1333);

var _BusinessTypeStyle2 = _interopRequireDefault(_BusinessTypeStyle);

var _BusinessTypeSearchInfoForm = __webpack_require__(1337);

var _BusinessTypeSearchInfoForm2 = _interopRequireDefault(_BusinessTypeSearchInfoForm);

var _BusinessTypeAddInfoForm = __webpack_require__(1334);

var _BusinessTypeAddInfoForm2 = _interopRequireDefault(_BusinessTypeAddInfoForm);

var _BusinessTypeEditInfoForm = __webpack_require__(1335);

var _BusinessTypeEditInfoForm2 = _interopRequireDefault(_BusinessTypeEditInfoForm);
...
var BusinessTypeListComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(BusinessTypeListComponent, _Component);

    function BusinessTypeListComponent(props) {
        _classCallCheck(this, BusinessTypeListComponent);

        var _this = _possibleConstructorReturn(this, (BusinessTypeListComponent.__proto__ || Object.getPrototypeOf(BusinessTypeListComponent)).call(this, props));
        ...
        _this.handleOkAdd = function (e) {
            _this.businessAddInfoForm.validateFields(function (err, data) {
                if (!err) {
                    _this.businessAddInfoFormDataRow = data;
                    _this.props.store.BusinessTypeAdd(_this.businessAddInfoFormDataRow, _this.data, _this.page);
                    _this.setState({
                        visibleAdd: false
                    });
                }
        ...
        _this.showModalSee = function (id) {
            ...
            _this.props.store.BusinessTypeSelectByKey({ id: id });
        };
        ...
        _this.handleOkEdit = function () {
            _this.businessEditInfoForm.validateFields(function (err, data) {
                if (!err) {
                    _this.businessEditInfoFormDataRow = data;
                    console.log(_this.businessEditInfoFormDataRow);
                    data.id = _this.id;
                    _this.props.store.BusinessTypeEdit(_this.businessEditInfoFormDataRow, _this.data, _this.page != null ? _this.page.pageNum : 1, _this.page != null ? _this.page.pageSize : 10);
                    _this.setState({
                        visibleEdit: false
                    });
                }
        ...
        props.store.BusinessTypeQuery({ condition: condition, current: current, pageSize: pageSize });
        props.store.BusinessTotalCount({ condition: condition });
        _this.state = {
            visibleSee: false,
            visibleAdd: false,
            visibleEdit: false,
    ...
    _createClass(BusinessTypeListComponent, [{
        key: 'changePage',
        value: function changePage(page) {
            ...
            this.props.store.BusinessTypeQuery({ condition: condition, current: current, pageSize: pageSize });
        }
    }, {
        key: 'getInfoForm',
        ...
        value: function search() {
            ...
            this.InfoForm.validateFields(function (err, data) {
                if (!err) {
                    ...
                    var _props$store3 = _this2.props.store,
                        current = _props$store3.current,
                        pageSize = _props$store3.pageSize;

                    _this2.props.store.BusinessTypeQuery({ condition: condition, current: current, pageSize: pageSize });
                    _this2.props.store.BusinessTotalCount({ condition: condition });
                }
            });
        }
    }, {
        key: 'getBusinessAddInfoForm',
        value: function getBusinessAddInfoForm(form) {
            this.businessAddInfoForm = form;
        }
    }, {
        key: 'getBusinessEditInfoForm',
        value: function getBusinessEditInfoForm(form) {
        ...
        value: function handleDel(id) {
            ...
            confirm({
                title: '确定要删除业务类型吗？',
                onOk: function onOk() {
                    _this3.props.store.BusinessTypeDel({ id: id }, _this3.data, _this3.page != null ? _this3.page.pageNum : 1, _this3.page != null ? _this3.page : 10);
                },
        ...
        value: function render() {
            ...
            var style = _BusinessTypeStyle2.default.style;
            var _props$store4 = this.props.store,
                condition = _props$store4.condition,
                current = _props$store4.current,
                totalCount = _props$store4.totalCount,
            ...
            var columns = [{
                ...
                render: function render(text, record) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _tooltip2.default,
                            { placement: 'top', title: '\u8BE6\u60C5', arrowPointAtCenter: true },
                            _react2.default.createElement(
                                'a',
                                { onClick: _this4.showModalSee.bind(_this4, record.id) },
                                _react2.default.createElement('i', { className: 'iconfont icon-chakan' })
                            ),
                            _react2.default.createElement('span', { className: 'ant-divider' })
                        ),
                        !cows.BusinessTypeEditAction ? "" : _react2.default.createElement(
                            _tooltip2.default,
                            { placement: 'top', title: '\u7F16\u8F91', arrowPointAtCenter: true },
                            _react2.default.createElement(
                                'a',
                                { onClick: _this4.showModalEdit.bind(_this4, record.id) },
                                _react2.default.createElement('i', { className: 'iconfont icon-bianji2' })
                            ),
                            _react2.default.createElement('span', { className: 'ant-divider' })
                        ),
                        !cows.BusinessTypeDelAction ? "" : _react2.default.createElement(
                            _tooltip2.default,
                            { placement: 'top', title: '\u5220\u9664', arrowPointAtCenter: true },
                            _react2.default.createElement(
                                'a',
                                { onClick: _this4.handleDel.bind(_this4, record.id) },
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                _col2.default,
                                { span: '12' },
                                !cows.BusinessTypeAddAction ? "" : _react2.default.createElement(
                                    _button2.default,
                                    { type: 'primary', className: 'btn', style: { width: "150px" }, onClick: this.showModalAdd.bind(this) },
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    _button2.default,
                                    { type: 'primary', className: 'btn', onClick: this.search.bind(this) },
                        ...
                        _react2.default.createElement(_BusinessTypeSearchInfoForm2.default, {
                    ...
                    _react2.default.createElement(
                        'div',
                        { style: style.ListTable },
                        _react2.default.createElement(_table2.default, { columns: columns, rowKey: function rowKey(record) {
                                return record.id;
                            }, dataSource: [].concat(_toConsumableArray(this.props.store.BusinessTypeDataTable)), pagination: this.state.pagination, size: 'middle' })
                    ),
                    _react2.default.createElement(
                        _modal2.default,
                        {
                        ...
                        _react2.default.createElement(_BusinessTypeAddInfoForm2.default, {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_BusinessTypeEditInfoForm2.default, {
    ...
    return BusinessTypeListComponent;
}(_react.Component)) || _class;

var BusinessTypeListInfoForm = _form2.default.create()(BusinessTypeListComponent);

exports.default = BusinessTypeListInfoForm;
...
var BusinessTypeSearchComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(BusinessTypeSearchComponent, _Component);

    function BusinessTypeSearchComponent(props) {
        _classCallCheck(this, BusinessTypeSearchComponent);

        var _this = _possibleConstructorReturn(this, (BusinessTypeSearchComponent.__proto__ || Object.getPrototypeOf(BusinessTypeSearchComponent)).call(this, props));

        props.postForm(props.form);
        return _this;
    }

    _createClass(BusinessTypeSearchComponent, [{
        key: 'render',
        value: function render() {
            var getFieldDecorator = this.props.form.getFieldDecorator;
    ...
    return BusinessTypeSearchComponent;
}(_react.Component)) || _class;

var BusinessTypeSearchInfoForm = _form2.default.create()(BusinessTypeSearchComponent);

exports.default = BusinessTypeSearchInfoForm;
