...
var _AccountingEditForm = __webpack_require__(1323);

var _AccountingEditForm2 = _interopRequireDefault(_AccountingEditForm);
...
var AccountingEditContainer = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(AccountingEditContainer, _Component);

    function AccountingEditContainer(props) {
        _classCallCheck(this, AccountingEditContainer);

        // this.fileLists=this.props.store.attachment;
        var _this = _possibleConstructorReturn(this, (AccountingEditContainer.__proto__ || Object.getPrototypeOf(AccountingEditContainer)).call(this, props));

        _this.fileLists = [];
        _this.attachment = {};
        _this.accountId = _this.props.match.params.Id;
        _this.accountInout = _this.props.match.params.Inout;
        props.store.selectAccount(_this.accountId);
    ...
    _createClass(AccountingEditContainer, [{
        key: "getFileLists",
        value: function getFileLists(files) {
            this.fileLists = files;
        }
    }, {
        key: "getAccountingEdit",
        value: function getAccountingEdit(form) {
        ...
        key: "deleteFile",
        value: function deleteFile(value, id) {
        ...
        value: function handleSubmit() {
            ...
            var flagEdit = true;
            this.accountingEditForm.validateFields(function (err, data) {
                if (!err) {
                    _this2.accountingEditFormDataRow = data;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _breadcrumb2.default.Item,
                        null,
                        this.accountInout == "1" ? "编辑收入" : this.accountInout == "0" ? "编辑支出" : null
                    )
                ),
                _react2.default.createElement(_AccountingEditForm2.default, {
    ...
    return AccountingEditContainer;
}(_react.Component)) || _class;

exports.default = AccountingEditContainer;
...
var _AccountingUploadFile = __webpack_require__(1324);
...
var ProductComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function ProductComponent(props) {
        ...
        _this.setTradeTime = function (data, dateString) {
            _this.props.form.setFieldsValue({ tradeTime: dateString });
        };

        _this.handleSelect = function (value, option) {
            _this.props.form.setFieldsValue({ 'settlementObjectName': option.props.children });
            _this.props.form.setFieldsValue({ 'settlementObjectId': option.props.eventKey });
                ...
                _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                getFieldDecorator('tradeTime', {
                                    ...
                                    initialValue: account.tradeTime ? (0, _moment2.default)(account.tradeTime) : ""
                                })(_react2.default.createElement(_datePicker2.default, { onChange: this.setTradeTime.bind(this), className: 'fullWidth' }))
                            )
                        )
                    ),
                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout2, { label: '\u8D26\u5957\u5E01\u79CD' }),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: '\u6C47\u7387' }),
...
var AccountingEditForm = _form2.default.create()(ProductComponent);

exports.default = AccountingEditForm;
