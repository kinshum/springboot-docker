    ...
    _createClass(RegistrationForm, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    FormItem,
                    _extends({}, formItemLayout, { label: '\u7528\u6237\u7EC4\uFF1A' }),
                    getFieldDecorator('role', {
                        ...
                        this.props.roleDataTable.map(function (role, index) {
                            return _react2.default.createElement(
                                Option,
                                { value: role.id.toString(), key: role.id },
                                role.name
                            );
                        })
                    ))
...
var UserListRoleForm = _form2.default.create()(RegistrationForm);
exports.default = UserListRoleForm;
...
var _UserSettingStyle = __webpack_require__(1385);

var _UserSettingStyle2 = _interopRequireDefault(_UserSettingStyle);

var _UserListRoleForm = __webpack_require__(1383);

var _UserListRoleForm2 = _interopRequireDefault(_UserListRoleForm);
...
var UserAddContainer = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(UserAddContainer, _Component);

    function UserAddContainer(props) {
        _classCallCheck(this, UserAddContainer);

        var _this = _possibleConstructorReturn(this, (UserAddContainer.__proto__ || Object.getPrototypeOf(UserAddContainer)).call(this, props));

        _this.page = { pageNum: 1, pageSize: 10 };
        _this.data = {};
        props.store.selectUsers(_this.data, _this.page);
        props.store.userTotalCount(_this.data);
    ...
    _createClass(UserAddContainer, [{
        key: 'handleShowRole',
        value: function handleShowRole(id) {
        ...
        key: 'handleOkRole',
        value: function handleOkRole() {
            var _this2 = this;

            this.roleForm.validateFields(function (err, data) {
                if (!err) {
                    _this2.roleFormDataRow = data;
                    _this2.roleFormDataRow.userId = _this2.userId;
                    _this2.props.store.addUserRole(_this2.roleFormDataRow);
                    _this2.setState({
                        visibleRole: false
                    });
                }
        ...
        value: function render() {
            ...
            var style = _UserSettingStyle2.default.style;

            var store = this.props.store;
            var columns = [{ title: '用户名', dataIndex: 'userName', key: 'userName' }, { title: '电子邮箱', dataIndex: 'email', key: 'email' }, { title: '操作', key: 'action', render: function render(text, item) {
                    return _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(
                            _tooltip2.default,
                            { placement: 'top', title: '\u89D2\u8272', arrowPointAtCenter: true },
                            _react2.default.createElement(
                                'a',
                                { onClick: function onClick() {
                                        _this3.handleShowRole(item.id);
                                    } },
                                _react2.default.createElement(_icon2.default, { type: 'usergroup-add', style: { fontSize: 19 } })
                            )
                        )
                    );
                } }];
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_table2.default, { columns: columns, dataSource: [].concat(_toConsumableArray(store.userDataTable)), pagination: false, rowKey: function rowKey(item) {
                        return item.id;
                    }, size: 'middle', className: 'pd', style: style.FormStyle }),
                _react2.default.createElement(_pagination2.default, { style: style.Pagination, current: this.page.pageNum, pageSize: this.page.pageSize, total: store.totalCount, onChange: this.changePage.bind(this) }),
                _react2.default.createElement(
                    _modal2.default,
                    {
                        title: '\u8BBE\u7F6E\u89D2\u8272',
                    ...
                    _react2.default.createElement(_UserListRoleForm2.default, { postForm: this.getForm.bind(this), roleDataRow: store.roleDataRow, roleDataTable: store.roleDataTable })
                )
            );
        }
    }]);

    return UserAddContainer;
}(_react.Component)) || _class;

exports.default = UserAddContainer;
