...
var SettlementComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function SettlementComponent(props) {
        ...
        _this.goTo = function (url, arg) {
            _this.props.handleAddTab(url, arg);
        };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _col2.default,
                        { span: '4' },
                        !cows.SettlementAddAction ? "" : _react2.default.createElement(
                            _button2.default,
                            { type: 'primary', className: 'btn', onClick: this.goTo.bind(this, '/Frame/SettlementAdd', "") },
                    ...
                    _react2.default.createElement(
                        _col2.default,
                        { span: '4', push: '16', style: { textAlign: "right" } },
                        _react2.default.createElement(
                            _button2.default,
                            { type: 'primary', className: 'btn', onClick: this.props.search.bind(this) },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: '\u7ED3\u7B97\u5BF9\u8C61\u540D\u79F0' }),
...
var SettlementSearchForm = _form2.default.create()(SettlementComponent);

exports.default = SettlementSearchForm;
...
var _SettlementInfoForm = __webpack_require__(1377);

var _SettlementInfoForm2 = _interopRequireDefault(_SettlementInfoForm);
...
var SettlementListContainer = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(SettlementListContainer, _Component);

    function SettlementListContainer(props) {
        _classCallCheck(this, SettlementListContainer);

        var _this = _possibleConstructorReturn(this, (SettlementListContainer.__proto__ || Object.getPrototypeOf(SettlementListContainer)).call(this, props));
        ...
        props.store.SettlementQuery({ condition: condition, pageSize: pageSize, current: current });
        props.store.SettlementTotalCount({ condition: condition });
        _this.state = {
            pagination: false
        };
        return _this;
    ...
    _createClass(SettlementListContainer, [{
        key: 'changePage',
        value: function changePage(page) {
            ...
            this.props.store.SettlementQuery({ condition: condition, current: current, pageSize: pageSize });
        }
    }, {
        key: 'getListForm',
        value: function getListForm(form) {
            this.listForm = form;
        }
    }, {
        key: 'search',
        value: function search() {
            ...
            this.listForm.validateFields(function (err, data) {
                if (!err) {
                    _this2.data = data;
                    _this2.data.settlementObjectId = data.settlementObjectId ? data.settlementObjectId.trim() : undefined;
                    _this2.data.orgCname = data.orgCname ? data.orgCname.trim() : undefined;
                    ...
                    _this2.props.store.SettlementQuery({ condition: condition, current: current, pageSize: pageSize });
                    _this2.props.store.SettlementTotalCount({ condition: condition });
                }
            });
        }
    }, {
        ...
        value: function render() {
                ...
                render: function render(text, record) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { onClick: _this3.goTo.bind(_this3, '/Frame/SettlementDetail', '' + record.id) },
                                _react2.default.createElement('i', { className: 'iconfont icon-chakan' })
                            ),
                            _react2.default.createElement('span', { className: 'ant-divider' })
                        ),
                        !cows.SettlementEditAction ? "" : _react2.default.createElement(
                            _tooltip2.default,
                            { placement: 'top', title: '\u7F16\u8F91', arrowPointAtCenter: true },
                            _react2.default.createElement(
                                'a',
                                { onClick: _this3.goTo.bind(_this3, "/Frame/SettlementEdit", '' + record.id) },
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_SettlementInfoForm2.default, {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(_table2.default, { columns: columns, rowKey: function rowKey(record) {
                                return record.id;
                            }, dataSource: [].concat(_toConsumableArray(this.props.store.SettlementDataTable)), pagination: this.state.pagination, size: 'middle' })
                    )
                ),
    ...
    return SettlementListContainer;
}(_react.Component)) || _class;

exports.default = SettlementListContainer;
