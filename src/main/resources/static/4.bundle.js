...
var ProductComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    _createClass(ProductComponent, [{
        ...
        value: function handleCancle() {
            ...
            var close = document.getElementsByClassName("anticon-cross")[0];
            if (close) {
                close.click();
            }
            this.props.onCancel();
...
var _ReceiptManageStyle = __webpack_require__(1216);

var _ReceiptManageStyle2 = _interopRequireDefault(_ReceiptManageStyle);

var _ReceiptManageSearchForm = __webpack_require__(1371);

var _ReceiptManageSearchForm2 = _interopRequireDefault(_ReceiptManageSearchForm);

var _InvoiceModalForm = __webpack_require__(1369);
...
var ProductComponent = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_Component) {
    _inherits(ProductComponent, _Component);
    ...
    function ProductComponent(props) {
        ...
        var _this$props$store = _this.props.store,
            ...
            pageSize = _this$props$store.pageSize;

        props.store.searchAllAccountObj({});
        props.store.searchReceiveList({ condition: condition, current: current, pageSize: pageSize });
        props.store.receiveTotalCount({ condition: condition });
        return _this;
    }
    ...
    _createClass(ProductComponent, [{
        ...
        value: function handleSubmit() {
            ...
            this.searchForm.validateFields(function (err, data) {
                ...
                if (err) {
                    ...
                    _this2.props.store.searchReceiveList({ condition: condition, current: current, pageSize: pageSize });
                    _this2.props.store.receiveTotalCount({ condition: condition });
                }
            });
        }
    }, {
        ...
        value: function changePage(page) {
            ...
            var _props$store3 = this.props.store,
                condition = _props$store3.condition,
                pageSize = _props$store3.pageSize;

            this.props.store.clearData();
            this.props.store.searchReceiveList({ condition: condition, current: current, pageSize: pageSize });
        }
    }, {
        key: 'getInvoiceForm',
        ...
        value: function render() {
            ...
            var _props$store4 = this.props.store,
                ...
                accountObjList = _props$store4.accountObjList,
                ReceiveList = _props$store4.ReceiveList,
                condition = _props$store4.condition;
            var style = _ReceiptManageStyle2.default.style;
            ...
            var columns = [{
                ...
                render: function render(text, record) {
                    return _react2.default.createElement(
                        'a',
                        { onClick: _this3.goTo.bind(_this3, "/Frame/ReceiptDetail", '' + record.id) },
                        record.billNo
                    );
                }
            }, {
                ...
                render: function render(text, record) {
                    return _react2.default.createElement(
                        ...
                        !cows.BillInvoicedAction ? "" : _react2.default.createElement(
                            ...
                            _react2.default.createElement('i', { onClick: _this3.showInvoicingModal.bind(_this3, record.id, record.status), className: 'iconfont icon-kbukaifapiao', style: { color: "#108ee9" } }),
                        ...
                        !cows.BillPaidAction ? "" : _react2.default.createElement(
                            ...
                            _react2.default.createElement('i', { onClick: _this3.showWirteOffModal.bind(_this3, record.id, record.status), className: 'iconfont icon-weibiaoti--', style: { color: "#108ee9" } })
                        )
                    );
                }
            }];
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_ReceiptManageSearchForm2.default, {
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_table2.default, {
                                columns: columns,
                                dataSource: [].concat(_toConsumableArray(ReceiveList)),
    ...
    this.hanleInvoiceOk = function () {
        _this4.invoiceForm.validateFields(function (err, data) {
            if (err) {
                // message.info("开票未成功，发票号不能为空");
                return;
            } else {
                var sendId = { id: _this4.state.billId };
                var sendData = Object.assign(data, sendId);
                var _props$store5 = _this4.props.store,
                    condition = _props$store5.condition,
                    current = _props$store5.current,
                    pageSize = _props$store5.pageSize;

                _this4.props.store.drawInvoice(sendData, _this4.state.attachment, condition, current, pageSize);
                _this4.setState({
                    invoicingVisible: false,
                    visibleInvoiceKey: _this4.state.visibleInvoiceKey + 1
                });
            }
        });
    };

    this.showInvoicingModal = function (id, status) {
        if (status >= 3) {
    ...
    this.showWirteOffModal = function (id, status) {
        if (status < 3) {
            ...
            _this4.setState({
                ...
                billId: id,
                visibleWriteOffKey: _this4.state.visibleWriteOffKey - 1
            });
        }
    };

    this.hideInvoicingModal = function () {
    ...
    this.hideWirteOffModal = function () {
    ...
    this.goTo = function (url, arg) {
        _this4.props.addTab(url, arg);
    };
}, _temp)) || _class;

var ReceiptManageContainer = _form2.default.create()(ProductComponent);

exports.default = ReceiptManageContainer;
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                })(_react2.default.createElement(_datePicker2.default, { onChange: this.handleSetCreateTime.bind(this), className: 'fullWidth' }))
                            )
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                })(_react2.default.createElement(_datePicker2.default, { onChange: this.handleSetEndTime.bind(this), className: 'fullWidth' }))
                            )
                        )
                    )
                )
...
var ReceiptManageSearchForm = _form2.default.create()(ProductComponent);

exports.default = ReceiptManageSearchForm;
