...
var _rcInputNumber = __webpack_require__(1173);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_objectWithoutProperties__ = __webpack_require__(456);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rc_touchable__ = __webpack_require__(1176);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_create_react_class__ = __webpack_require__(934);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_create_react_class___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_create_react_class__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_classnames__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__mixin__ = __webpack_require__(1174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__InputHandler__ = __webpack_require__(1172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PressEvent__ = __webpack_require__(1175);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var _AccountingAddForm = __webpack_require__(1317);

var _AccountingAddForm2 = _interopRequireDefault(_AccountingAddForm);
...
var AccountingAddContainer = (0, _mobxReact.observer)(_class = function (_Component) {
    _inherits(AccountingAddContainer, _Component);

    function AccountingAddContainer(props) {
        _classCallCheck(this, AccountingAddContainer);

        var _this = _possibleConstructorReturn(this, (AccountingAddContainer.__proto__ || Object.getPrototypeOf(AccountingAddContainer)).call(this, props));

        _this.fileLists = [];
        _this.attachment = {};
        _this.accounType = _this.props.match.params.Type;
    ...
    _createClass(AccountingAddContainer, [{
        key: 'getAccountingAdd',
        value: function getAccountingAdd(form) {
            this.accountingAddForm = form;
        }
    }, {
        key: 'accountGetrate',
        value: function accountGetrate(values, form) {
            this.props.store.accountGetrate(values, form);
        }
    }, {
        key: 'accountAmount',
        value: function accountAmount(values, form) {
            this.props.store.accountAmount(values, form);
        }
    }, {
        key: 'myexchangeRate',
        value: function myexchangeRate(values, form) {
        ...
        value: function handleSubmit() {
            ...
            var flagAdd = true;
            this.accountingAddForm.validateFields(function (err, data) {
                if (!err) {
                    _this2.accountingAddFormDataRow = data;
                    _this2.fileLists.map(function (item) {
                        if (!item.url) {
                            _this2.attachment.attachmentUrl = item.response.attachmentUrl;
                            _this2.attachment.pictureName = item.response.pictureName;
                        }
                    });
                } else {
                    flagAdd = false;
        ...
        key: 'categoryLevel',
        value: function categoryLevel(value) {
            this.props.store.AccountCategory(value);
        }
    }, {
        key: 'categoryLevel2',
        value: function categoryLevel2(value) {
            this.props.store.AccountCategory2(value);
        }
    }, {
        key: 'getFileLists',
        value: function getFileLists(files) {
            this.fileLists = files;
        }
    }, {
        key: 'deleteFile',
        value: function deleteFile(value) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _breadcrumb2.default.Item,
                        null,
                        this.accounType == "1" ? "新增收入" : this.accounType == "0" ? "新增支出" : null
                    )
                ),
                _react2.default.createElement(
                    'div',
                    { style: { margin: "0px 10px" } },
                    _react2.default.createElement(_AccountingAddForm2.default, {
    ...
    return AccountingAddContainer;
}(_react.Component)) || _class;

exports.default = AccountingAddContainer;
...
var _inputNumber = __webpack_require__(1156);
...
var _AccountingUploadFile = __webpack_require__(1318);

var _AccountingUploadFile2 = _interopRequireDefault(_AccountingUploadFile);
...
var ProductComponent = (0, _mobxReact.observer)(_class = function (_Component) {
    ...
    function ProductComponent(props) {
        ...
        _this.setUploadFiled = function (Files) {
            _this.props.getFileLists(Files);
            _this.fileList = Files;
        };

        _this.deleteFile = function (File) {
            _this.props.deleteFile(File);
        };
        ...
        _this.handleSelect = function (value, option) {
            ...
            _this.props.form.getFieldDecorator('settlementCurrency', { initialValue: option.props.currency });
            var currency = _this.props.form.getFieldValue('currency');
            if (currency) {
                _this.props.myexchangeRate({ currency1: currency, currency2: option.props.currency }, _this.props.form);
            }
        };
    ...
    _createClass(ProductComponent, [{
        ...
        value: function handleCategorySelect(value, option) {
        ...
        key: "handleCategory2Select",
        value: function handleCategory2Select(value, option) {
            this.props.form.getFieldDecorator('categoryLevel2Code', { initialValue: option.props.content });
        }
    }, {
        key: "handleAmount",
        value: function handleAmount(value) {
            var currency = this.props.form.getFieldValue('currency');
            var accountCurrency = this.props.form.getFieldValue('accountCurrency');
            if (currency) {
                this.props.accountAmount({ currency1: currency, currency2: accountCurrency }, this.props.form);
            }
        }
    }, {
        key: "handleCurrencySelect",
        value: function handleCurrencySelect(value, option) {
            var accountCurrency = this.props.form.getFieldValue('accountCurrency');
            var settlementCurrency = this.props.form.getFieldValue('settlementCurrency');
            var amount = this.props.form.getFieldValue('amount');
            if (amount) {
        ...
        value: function render() {
            ...
            var _props = this.props,
                categoryDataTable = _props.categoryDataTable,
                categoryDataTable2 = _props.categoryDataTable2,
                exchangeRate = _props.exchangeRate,
                myExchangeRate = _props.myExchangeRate;

            var currency = void 0;
            this.props.currency.map(function (item, index) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        " ",
                        this.props.accounType == "1" ? "新增收入" : this.props.accounType == "0" ? "新增支出" : null,
                        "\xA0\xA0"
                    ),
                    _react2.default.createElement(
                        _row2.default,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                getFieldDecorator('refNo', {
                                    rules: [{ required: true, message: '请填写业务编码！' }, { max: 20, message: '业务编码过长！' }]
                            ...
                            _react2.default.createElement(
                                ...
                                getFieldDecorator('settlementObjectId', {
                                    ...
                                    this.props.data.map(function (item, index) {
                                        return _react2.default.createElement(
                                            Option,
                                            { value: item.id.toString(), currency: item.currency, key: item.id },
                                            item.orgCname
                                        );
                                    })
                                ))
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                getFieldDecorator('businessType', {
                                    ...
                                    _select2.default,
                                    null,
                                    this.props.businessTypeDataTable.map(function (item, index) {
                                        return _react2.default.createElement(
                                            Option,
                                            { value: item.businessTypeName, key: item.id },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: "\u4EA4\u6613\u65F6\u95F4" }),
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: "\u8D39\u7528\u7C7B\u522B" }),
                                getFieldDecorator('categoryLevel1Name', {
                                    rules: [{ required: true, message: '请填写费用类别！' }]
                                })(_react2.default.createElement(
                                    _select2.default,
                                    { onSelect: this.handleCategorySelect.bind(this) },
                                    categoryDataTable.map(function (category) {
                                        return _react2.default.createElement(
                                            Option,
                                            { key: category.categoryName, content: category.id },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: "\u8D39\u7528\u660E\u7EC6" }),
                                getFieldDecorator('categoryLevel2Name', {
                                    rules: [{ required: true, message: '请填写费用明细！' }]
                                })(_react2.default.createElement(
                                    _select2.default,
                                    { onSelect: this.handleCategory2Select.bind(this) },
                                    categoryDataTable2.map(function (category) {
                                        return _react2.default.createElement(
                                            Option,
                                            { key: category.categoryName, content: category.id },
                                            category.categoryName
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout2, { label: "\u4EA4\u6613\u91D1\u989D" }),
                                getFieldDecorator('amount', {
                                    rules: [{ required: true, message: '请填写交易金额！' }]
                                })(_react2.default.createElement(_inputNumber2.default, { min: 0, step: 0.01, onChange: this.handleAmount.bind(this) }))
                            )
                        ),
                        _react2.default.createElement(
                            _col2.default,
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout3, { label: "" }),
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout2, { label: "\u7ED3\u7B97\u91D1\u989D" }),
                                getFieldDecorator('settelmentAmount', {
                                    rules: [{ required: true, message: '请填写结算金额！' }]
                                })(_react2.default.createElement(_inputNumber2.default, { min: 0, step: 0.01 }))
                            )
                        ),
                        _react2.default.createElement(
                            _col2.default,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: "\u8D26\u5957\u6C47\u7387" }),
                                getFieldDecorator('exchangeRate', {
                                    rules: [{ required: true, message: '请填写账套汇率！' }],
                                    initialValue: exchangeRate
                                })(_react2.default.createElement(_inputNumber2.default, { min: 0, step: 0.001 }))
                            )
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout2, { label: "\u7ED3\u7B97\u5BF9\u8C61\u6C47\u7387" }),
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout, { label: "\u4EA4\u6613\u6982\u8981" }),
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                FormItem,
                                _extends({}, formItemLayout1, { label: "\u4E0A\u4F20\u9644\u4EF6", extra: "" }),
                                _react2.default.createElement(_AccountingUploadFile2.default, {
...
var AccountingAddForm = _form2.default.create()(ProductComponent);

exports.default = AccountingAddForm;
...
var AccountingUploadFile = function (_Component) {
    _inherits(AccountingUploadFile, _Component);

    function AccountingUploadFile(props) {
        _classCallCheck(this, AccountingUploadFile);

        var _this = _possibleConstructorReturn(this, (AccountingUploadFile.__proto__ || Object.getPrototypeOf(AccountingUploadFile)).call(this, props));
        ...
        _this.handleChange = function (_ref) {
            ...
            _this.props.setUploadFiled(fileList);
        };
        ...
        _this.handleRemove = function (file) {
            ...
            _this.props.deleteFile(sendData);
        };
    ...
    _createClass(AccountingUploadFile, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(nextProps) {
    ...
    return AccountingUploadFile;
}(_react.Component);

exports.default = AccountingUploadFile;
