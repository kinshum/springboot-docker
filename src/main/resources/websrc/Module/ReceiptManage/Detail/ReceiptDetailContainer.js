...
class ProductComponent extends Component
{
    constructor(props){
        ...
        props.store.searchReceiptByKey({billNo:this.id})
        //查询单条账单信息
    ...
    render(){
        ...
        let ReceiptDetailTable=store.ReceiptDetailTable;
        ...
        return(
            <div>
                ...
                <div style={{backgroundColor:"rgb(250, 250, 247)"}}>
                        ...
                        <Row style={{paddingTop:"30px"}}>
                            ...
                            <Col span="6">
                                <Col span="8"  style={{textAlign:"right",color:"rgba(0, 0, 0, 0.85)"}}>
                                    <span onClick={this.showNoteModal.bind(this)} style={{lineHeight:"32px"}}>
                                        关联附件：
                                    </span>
                                </Col>
                    ...
                    <div style={{paddingTop:"30px",margin:"0 30px"}}>
                        <Row style={{marginTop:"10px"}}>
                            ...
                            <Col span="3">
                                共计：{ReceiptDetailTable.length}条
                            </Col>
                            <Col span="3">
                    ...
                    <div  style={style.ListTable}>
                        <Table columns={columns} rowKey={record => record.id} dataSource={[...store.ReceiptDetailTable]} pagination={this.state.pagination} size="middle"></Table>
                    </div>
                </div>
                </div>
                ...
                <Row style={style.AddBottom}>
                    <Col span={9}>
                        {/*<Button type="primary" onClick={this.handleSubmit.bind(this)} style={style.SubmitBtn}><icon className="iconfont icon-daochu"/>导出</Button>*/}
                    </Col>
                    <Col span={15}>
                        <Button type="default" onClick={() =>{window.location.hash="/Frame/ReceiptList"}} style={style.CancelBtn}>返回</Button>
                    </Col>
                </Row>
            </div>
        )
...
const ReceiptDetailContainer =Form.create()(ProductComponent);
