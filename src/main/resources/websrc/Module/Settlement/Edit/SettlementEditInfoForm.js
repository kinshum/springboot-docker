...
class SettlementComponent extends Component {
    ...
    handleSettlementOnlyOneName = (rule, value, callback)=>{
        let common = this.props.store.orgShortname;
        if(!value || value==common){
            callback();
        }else{
        ...
        return (
            <div>
                <Form style={style.FormStyle}>
                    ...
                    <p style={style.hFormStyle}>&nbsp;&nbsp;<Icon type="book" /> 编辑结算对象&nbsp;&nbsp;</p>
...
const SettlementEditInfoForm=Form.create()(SettlementComponent);

export default SettlementEditInfoForm;